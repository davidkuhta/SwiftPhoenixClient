...
//  json
//
//  Original Swift file created by Dan Kogai on 7/15/14 Copyright (c) 2014 Dan Kogai All rights reserved.
//  Updated to Swift3 by David Kuhta on 6/29/16
//
import Foundation
/// init
public class JSON {
  ...
  public class func unwrap(_ obj:AnyObject) -> AnyObject {
    switch obj {
